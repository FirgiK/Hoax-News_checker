...
namespace ModelDeteksiHoaks.ConsoleApp
{
    ...
    {
        /// <summary>
        /// model input class for ModelDeteksiHoaks.
        /// </summary>
        ...
        /// <summary>
        /// model output class for ModelDeteksiHoaks.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("ModelDeteksiHoaks.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("v1");
            if (labelColumn == null)
            {
                throw new Exception("v1 column not found. Make sure the name searched for matches the name in the schema.");
            }

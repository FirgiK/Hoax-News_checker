...
{
    public partial class ModelDeteksiHoaks
    {
        public const string RetrainFilePath =  @"C:\Users\Leira\Documents\Tugas\aingMaung\Hoax-News_checker\spam.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"v1",inputColumnName:@"v1",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"v1", sentence1ColumnName: @"v2"))      
